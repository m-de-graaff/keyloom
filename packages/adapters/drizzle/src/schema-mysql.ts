/**
 * MySQL schema for Keyloom authentication
 */
...
// MySQL Schema with utf8mb4 support
...
export const auditEvents = mysqlTable('AuditEvent', {
  id: varchar('id', { length: 191 }).primaryKey(),
...
export const memberships = mysqlTable('Membership', {
  id: varchar('id', { length: 191 }).primaryKey(),
  userId: varchar('userId', { length: 191 }).notNull().references(() => users.id, { onDelete: 'cascade' }),
...
export const entitlements = mysqlTable('Entitlement', {
  id: varchar('id', { length: 191 }).primaryKey(),
